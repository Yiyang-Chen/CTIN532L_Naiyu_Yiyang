...
public class FishCircle304 : FishCircle
{
    Vector3[] velocities;
    float[] minTimes;
    float[] maxTimes;
    ...
    {
        MakeErosionCloud("_Perfab/Fishing/Hooking/CircleErosionCloud", new Vector3(2, 0, 0), new Vector3(1f, 1f, 1), 0, 100f);
        MakeErosionCloud("_Perfab/Fishing/Hooking/CircleErosionCloud", new Vector3(-2, 0, 0), new Vector3(1f, 1f, 1), 0, 100f);
        MakeErosionCloud("_Perfab/Fishing/Hooking/CircleErosionCloud", new Vector3(0, 2, 0), new Vector3(1f, 1f, 1), 0, 100f);
        MakeErosionCloud("_Perfab/Fishing/Hooking/CircleErosionCloud", new Vector3(0, -2, 0), new Vector3(1f, 1f, 1), 0, 100f);
